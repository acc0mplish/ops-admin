...
const ko = {
  ...
  computeTitle: '컴퓨트 인벤토리', computeDesc: 'V2 동기화가 수집한 클라우드 컴퓨트 리소스(compute.*) 인벤토리를 조회합니다.',
...
const en = {
  ...
  computeTitle: 'Compute Inventory', computeDesc: 'Browse the cloud compute (compute.*) resource inventory collected by the V2 sync pipeline.',
