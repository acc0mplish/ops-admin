...
const ko = {
  ...
  edit: '수정', deactivate: '비활성화', activate: '활성화', resetPassword: '비밀번호 초기화', delete: '삭제', cancel: '취소', save: '저장', create: '생성', password: '비밀번호', note: '비고',
...
const en = {
  ...
  edit: 'Edit', deactivate: 'Deactivate', activate: 'Activate', resetPassword: 'Reset Password', delete: 'Delete', cancel: 'Cancel', save: 'Save', create: 'Create', password: 'Password', note: 'Note',
