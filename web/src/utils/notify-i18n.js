...
const ko = {
  ...
  notify: '테스트 통지', waiting_approval: '승인 대기', pendingManualReview: '수동 확인 대기', rejected: '거부됨', firing: 'Alert 발생', recovered: 'Alert 복구',
...
const en = {
  ...
  notify: 'Test Notification', waiting_approval: 'Waiting for Approval', pendingManualReview: 'Pending Manual Review', rejected: 'Rejected', firing: 'Alert Firing', recovered: 'Alert Recovered',
