...
const messages = {
  'zh-CN': {
    ...
    saveConfig: '保存配置',
    configTitle: '基础配置',
    configDesc: '管理站点名称、登录页文案、Logo 和界面主色。',
    siteName: '站点名称',
    siteSlogan: '站点标语',
    logoType: 'Logo 方式',
    logoValue: 'Logo 内容',
    ...
    dashboardDesc: '当前项目已经具备 system 域基础能力，可以作为你个人运维平台的核心管理台继续扩展。',
    userCount: '用户总数',
    roleCount: '角色总数',
    deptCount: '部门总数',
    postCount: '岗位总数',
  ...
  'en-US': {
    ...
    dashboardDesc: 'The project now has the core system domain and is ready to expand into your personal operations platform.',
    userCount: 'Users',
    roleCount: 'Roles',
