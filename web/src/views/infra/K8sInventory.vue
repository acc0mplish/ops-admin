<template>
  <div class="k8s-inventory">
    <div class="page-header">
      <div><h2 class="page-title">{{ inft('inventoryTitle') }}</h2><p class="page-desc">{{ inft('inventoryDesc') }}</p></div>
    ...
    <el-card shadow="never">
      ...
      <el-table v-loading="loading" :data="resources" size="small" @row-click="openDetail">
        ...
        <el-table-column prop="kind" :label="inft('kindCol')" min-width="170" />
...
const kindOptions = [
  ...
  'orchestration.configmap', 'orchestration.secret', 'network.load_balancer', 'storage.volume', 'storage.pool'
]
