...
export const analyzeRedisCommand = (data) => http.post('/api/v1/dbms/redis/analyze', data)
export const executeRedisCommand = (data) => http.post('/api/v1/dbms/redis/execute', data)
