...
func TestACMEDNSChallengeCreatesAndCleansTXTRecord(t *testing.T) {
	...
	challenge := &acmeDNSChallengeProvider{dns: mock, mainDomain: "example.com", timeout: time.Second, interval: 10 * time.Millisecond, recordIDsByKey: map[string][]string{}, recordFor: func(string, string) (string, string) { return "_acme-challenge.api.example.com.", "validation-token" }}
